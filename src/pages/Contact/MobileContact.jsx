...
function MobileContact() {
  ...
  return (
    <div className='grid text-center justify-center items-center mt-32'>
        ...
        <div className=''>
          <p className='dark:text-gray-300 text-[20px] leading-[35px] word-break mt-[24px] w-[550px] whitespace-no-wrap'>If you have any exciting projects in mind that you'd like us to collaborate on, feel free to reach out. I enjoy bringing ideas to life. Let's work together and make magic happen!</p>
        ...
        <form ref={form} className="space-y-4 h-[400px] flex items-center justify-center ml-10" onSubmit={handleSubmit}>
          <div className="items-center justify-center place-items-center grid gap-4">
            ...
            <button className="items-center justify-center place-items-center grid mt-4" type='submit'>
